...
let GetAnalytics = {
  analytics: (engine, dataElements, period, groupID) => {
    ...
    const analystisQuery = {
      analytics: {
        resource: `analytics?dimension=dx:${dataDimension},ou:OU_GROUP-${groupID},pe:${joinedPE}&displayProperty=NAME&includeNumDen=true&skipMeta=false&skipData=false&includeMetadataDetails=true`,
        params: {},
      },
    };
